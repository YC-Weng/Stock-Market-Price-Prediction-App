...
enum URLServices {
    ...
    //static let stocks = URL(string:"http://140.114.87.235:8080/ML_Server/CompanyServlet/Data")
    static let stocks: String = "http://27.247.28.182:8080/ML_Server/CompanyServlet"
}
